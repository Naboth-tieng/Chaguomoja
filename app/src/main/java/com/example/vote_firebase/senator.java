...
public class senator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.vit);
        textView.setText(county);

        Button vote= findViewById(R.id.svote);
        ...
        databaseReference.child("candidates").child("senator").child(county).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        vote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(senator.this,Sname,Toast.LENGTH_SHORT).show();

                //pass the vote to database
                databaseReference.child("vote").child("senator").child(county).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.hasChild(Sname)) {
                            ...
                            cast = cast+1;
                            databaseReference.child("vote").child("senator").child(county).child(Sname).child("total").setValue(cast);

                        } else {
                            databaseReference.child("vote").child("senator").child(county).child(Sname).child("total").setValue(1);
                        }
                ...
                // go to governor
                Intent i = new Intent(senator.this,Governor.class);
